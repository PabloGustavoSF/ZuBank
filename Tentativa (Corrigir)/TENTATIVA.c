	...
	do{
		...
		switch (servico.servico){
			case 1:
				...
				break;
			case 2: //TAXA DO CDB DE REFERÊNCIA É DE 11.45% a.a COM 102% DO CDI PELO BANCO INTER EM OUTUBRO/24
					//O RENDIMENTO CDB EM VÁRIOS BANCOS É DIÁRIO, MAS PARA FACILITAR O USO (entrada) DO PROGRAMA, FOI UTILIZADO O RENDIMENTO MENSAL
				do{
